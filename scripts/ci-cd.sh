...
docker build -t ghcr.io/jamestiberiuskirk/fl-tp-types:latest . --build-arg PAT=$PAT
docker push ghcr.io/jamestiberiuskirk/fl-tp-types:latest # This is disabled in the template